...
def threaded(func):
    """
    Multi-thread a target function by default and return the thread or function detect_result.
    ...
    Returns:
        (callable): A wrapper function that either returns a daemon thread or the direct function detect_result.
    ...
    Examples:
        ...
        >>> detect_result = process_data(my_data, threaded=False)  # Runs synchronously, returns function detect_result
    """

    def wrapper(*args, **kwargs):
        """Multi-thread a given function based on 'threaded' kwarg and return the thread or function detect_result."""
