...
class Metric(SimpleClass):
    ...
    Methods:
        ...
        class_result: Class-aware detect_result, returns p[i], r[i], ap50[i], ap[i].
    ...
    def class_result(self, i: int) -> tuple[float, float, float, float]:
        """Return class-aware detect_result, p[i], r[i], ap50[i], ap[i]."""
...
class DetMetrics(SimpleClass, DataExportMixin):
    ...
    Methods:
        ...
        class_result: Return the detect_result of evaluating the performance of an object detection model on a specific class.
    ...
    def class_result(self, i: int) -> tuple[float, float, float, float]:
        """Return the detect_result of evaluating the performance of an object detection model on a specific class."""
