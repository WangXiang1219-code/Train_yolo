...
class BaseMixTransform:
    ...
    def __call__(self, labels: dict[str, Any]) -> dict[str, Any]:
        ...
        Examples:
            ...
            >>> detect_result = transform({"image": img, "bboxes": boxes, "cls": classes})
        """
...
class Mosaic(BaseMixTransform):
    ...
    def _mosaic3(self, labels: dict[str, Any]) -> dict[str, Any]:
        ...
        Examples:
            ...
            ... }
            >>> detect_result = mosaic._mosaic3(labels)
            >>> print(detect_result["img"].shape)
            (640, 640, 3)
        """
        mosaic_labels = []
        s = self.imgsz
    ...
    def _mosaic4(self, labels: dict[str, Any]) -> dict[str, Any]:
        ...
        Examples:
            ...
            ... }
            >>> detect_result = mosaic._mosaic4(labels)
            >>> assert detect_result["img"].shape == (1280, 1280, 3)
        """
        mosaic_labels = []
        s = self.imgsz
    ...
    def _cat_labels(self, mosaic_labels: list[dict[str, Any]]) -> dict[str, Any]:
        ...
        Examples:
            ...
            >>> detect_result = mosaic._cat_labels(mosaic_labels)
...
class RandomPerspective:
    ...
    Examples:
        ...
        >>> detect_result = transform(labels)
        >>> transformed_image = detect_result["img"]
        >>> transformed_instances = detect_result["instances"]
    """
    ...
    def __init__(
        ...
        Examples:
            ...
            >>> detect_result = transform(labels)  # Apply random perspective to labels
        """
    ...
    def __call__(self, labels: dict[str, Any]) -> dict[str, Any]:
        ...
        Examples:
            ...
            ... }
            >>> detect_result = transform(labels)
            >>> assert detect_result["img"].shape[:2] == detect_result["resized_shape"]
        """
...
class RandomFlip:
    ...
    Examples:
        ...
        >>> detect_result = transform({"img": image, "instances": instances})
        >>> flipped_image = detect_result["img"]
        >>> flipped_instances = detect_result["instances"]
    """
...
class LetterBox:
    ...
    Examples:
        ...
        >>> detect_result = transform(labels)
        >>> resized_img = detect_result["img"]
        >>> updated_instances = detect_result["instances"]
    """
    ...
    def __call__(self, labels: dict[str, Any] = None, image: np.ndarray = None) -> dict[str, Any] | np.ndarray:
        ...
        Examples:
            ...
            >>> detect_result = letterbox(labels={"img": np.zeros((480, 640, 3)), "instances": Instances(...)})
            >>> resized_img = detect_result["img"]
            >>> updated_instances = detect_result["instances"]
        """
        if labels is None:
