...
class OBBPredictor(DetectionPredictor):
    ...
    def construct_result(self, pred, img, orig_img, img_path):
        """
        Construct the detect_result object from the prediction.
        ...
        Returns:
            (Results): The detect_result object containing the original image, image path, class names, and oriented bounding
                boxes.
        """
