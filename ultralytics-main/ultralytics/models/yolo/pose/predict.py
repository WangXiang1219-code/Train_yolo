...
class PosePredictor(DetectionPredictor):
    ...
    Methods:
        construct_result: Construct the detect_result object from the prediction, including keypoints.
    ...
    def construct_result(self, pred, img, orig_img, img_path):
        """
        Construct the detect_result object from the prediction, including keypoints.
        ...
        Returns:
            (Results): The detect_result object containing the original image, image path, class names, bounding boxes, and
                keypoints.
        """
