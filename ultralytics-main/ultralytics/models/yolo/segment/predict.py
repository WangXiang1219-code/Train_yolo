...
class SegmentationPredictor(DetectionPredictor):
    ...
    Methods:
        ...
        construct_results: Construct a list of detect_result objects from predictions.
        construct_result: Construct a single detect_result object from a prediction.
    ...
    def construct_results(self, preds, img, orig_imgs, protos):
        """
        Construct a list of detect_result objects from the predictions.
        ...
        Returns:
            (list[Results]): List of detect_result objects containing the original images, image paths, class names,
    ...
    def construct_result(self, pred, img, orig_img, img_path, proto):
        """
        Construct a single detect_result object from the prediction.
